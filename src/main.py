...
"""
Test py_rust_numpy_ext
"""


import py_rust_numpy_ext as RNE
import numpy as np
...
def double_and_random_perturbation(array: np.ndarray, perturbation: float):
    RNE.double_and_random_perturbation(array, perturbation)